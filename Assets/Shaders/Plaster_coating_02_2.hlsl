...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[20] = float4(0.571125,0.571125,0.571125,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.571125,0.571125,0.571125,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(-0.072464,0.000000,0.352185,5.225972);//(Unknown)
	Material.PreshaderBuffer[30] = float4(5.225972,-0.072464,0.000000,0.352185);//(Unknown)
	Material.PreshaderBuffer[31] = float4(-0.072464,0.000000,0.352185,5.225972);//(Unknown)
	Material.PreshaderBuffer[32] = float4(-0.072464,0.000000,0.352185,5.225972);//(Unknown)
}
