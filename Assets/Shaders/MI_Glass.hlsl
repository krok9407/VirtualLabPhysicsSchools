...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[27] = float4(1.000000,1.520000,1.520000,2.520000);//(Unknown)
	Material.PreshaderBuffer[28] = float4(-0.520000,-0.206349,0.042580,0.532250);//(Unknown)
	Material.PreshaderBuffer[29] = float4(0.000000,0.000000,0.000000,1.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(0.000000,1.000000,0.957420,0.532250);//(Unknown)
	Material.PreshaderBuffer[31] = float4(1.000000,0.000000,0.000000,0.100000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.100000,-0.900000,0.000000,0.000000);//(Unknown)
}
MaterialFloat2 CustomExpression3(FMaterialVertexParameters Parameters,MaterialFloat Angle)
{
float s;
float c;
sincos(Angle, s, c);
...
void GetMaterialCustomizedUVs(FMaterialPixelParameters PixelParameters, inout float2 OutTexCoords[NUM_TEX_COORD_INTERPOLATORS])
{
	...
	MaterialFloat Local259 = (View.GameTime * Material.PreshaderBuffer[18].z);
	MaterialFloat Local260 = (View.GameTime * Material.PreshaderBuffer[18].w);
	MaterialFloat2 Local261 = Parameters.TexCoords[0].xy;
	MaterialFloat2 Local262 = (MaterialFloat2(-0.50000000,-0.50000000) + DERIV_BASE_VALUE(Local261));
	MaterialFloat2 Local263 = CustomExpression3(Parameters,Material.PreshaderBuffer[1].x);
	MaterialFloat Local264 = (Local263.r * -1.00000000);
	MaterialFloat Local265 = dot(DERIV_BASE_VALUE(Local262),MaterialFloat2(Local263.g,Local264));
	MaterialFloat Local266 = dot(DERIV_BASE_VALUE(Local262),Local263);
	MaterialFloat2 Local267 = (MaterialFloat2(0.50000000,0.50000000) + MaterialFloat2(Local265,Local266));
	MaterialFloat2 Local268 = (Material.PreshaderBuffer[22].zw + Local267);
	MaterialFloat2 Local269 = (Material.PreshaderBuffer[22].xy * Local268);
	MaterialFloat2 Local270 = (MaterialFloat2(Local259,Local260) + Local269);
	OutTexCoords[0] = Local270;
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local17 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 0);
	...
	MaterialFloat Local31 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 3);
	...
	MaterialFloat Local41 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 4);
	...
	MaterialFloat Local43 = MaterialStoreTexSample(Parameters, Local42, 4);
	...
	MaterialFloat Local52 = MaterialStoreTexCoordScale(Parameters, MaterialFloat2(Local51,Material.PreshaderBuffer[14].y), 7);
	...
	MaterialFloat Local163 = MaterialStoreTexCoordScale(Parameters, Local162, 1);
	...
	MaterialFloat Local165 = MaterialStoreTexSample(Parameters, Local164, 1);
	...
	MaterialFloat Local178 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local177), 2);
	...
	MaterialFloat Local180 = MaterialStoreTexSample(Parameters, Local179, 2);
	...
	MaterialFloat Local187 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local186), 2);
	...
	MaterialFloat Local189 = MaterialStoreTexSample(Parameters, Local188, 2);
	...
	MaterialFloat Local197 = MaterialStoreTexCoordScale(Parameters, Local196, 1);
	...
	MaterialFloat Local208 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 5);
	MaterialFloat4 Local209 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_7,GetMaterialSharedSampler(sampler_Material_Texture2D_7,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local16)));
	MaterialFloat Local210 = MaterialStoreTexSample(Parameters, Local209, 5);
	MaterialFloat Local211 = (1.00000000 - Local209.r);
	MaterialFloat Local212 = lerp(Local209.r,Local211,Material.PreshaderBuffer[26].w);
	MaterialFloat Local213 = (Local212 * Material.PreshaderBuffer[27].x);
	MaterialFloat Local214 = lerp(Local213,0.00000000,Local206);
	MaterialFloat4 Local215 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_8,GetMaterialSharedSampler(sampler_Material_Texture2D_8,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local16)));
	MaterialFloat Local216 = MaterialStoreTexSample(Parameters, Local215, 4);
	MaterialFloat Local217 = lerp(Local32.a,Local215.r,Material.PreshaderBuffer[29].x);
	MaterialFloat Local218 = (1.00000000 - Local217);
	MaterialFloat Local219 = lerp(Local217,Local218,Material.PreshaderBuffer[29].z);
	MaterialFloat Local220 = lerp(1.00000000,Local219,Material.PreshaderBuffer[29].w);
	MaterialFloat Local221 = (Local220 * Material.PreshaderBuffer[30].x);
	MaterialFloat Local222 = max(Local221,Material.PreshaderBuffer[30].y);
	MaterialFloat Local223 = dot(WorldNormalCopy,Parameters.CameraVector);
	MaterialFloat Local224 = abs(Local223);
	MaterialFloat Local225 = (1.00000000 - Local224);
	MaterialFloat Local226 = PositiveClampedPow(Local225,5.00000000);
	MaterialFloat Local227 = (Material.PreshaderBuffer[30].z * Local226);
	MaterialFloat Local228 = (Material.PreshaderBuffer[28].z + Local227);
	MaterialFloat Local229 = lerp(Local221,Local222,Local228);
	MaterialFloat Local230 = saturate(Local229);
	MaterialFloat Local231 = (1.00000000 - Local230);
	MaterialFloat Local232 = lerp(Material.PreshaderBuffer[31].x,Material.PreshaderBuffer[30].w,Local231);
	MaterialFloat Local233 = MaterialStoreTexCoordScale(Parameters, DERIV_BASE_VALUE(Local16), 6);
	MaterialFloat4 Local234 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_9,GetMaterialSharedSampler(sampler_Material_Texture2D_9,View_MaterialTextureBilinearWrapedSampler),DERIV_BASE_VALUE(Local16)));
	MaterialFloat Local235 = MaterialStoreTexSample(Parameters, Local234, 6);
	MaterialFloat Local236 = (1.00000000 - Local234.r);
	MaterialFloat Local237 = lerp(Local234.r,Local236,Material.PreshaderBuffer[31].z);
	MaterialFloat Local238 = lerp(0.00000000,Local237,Material.PreshaderBuffer[32].x);
	MaterialFloat Local239 = lerp(Local238,1.00000000,Material.PreshaderBuffer[32].z);
	MaterialFloat Local240 = (Local206 * 0.50000000);
	MaterialFloat Local241 = lerp(Local239,1.00000000,Local240);
	MaterialFloat Local242 = lerp(Local230,1.00000000,Local206);
	MaterialFloat Local243 = (GetPathTracingQualitySwitch() ? (Material.PreshaderBuffer[27].z) : (1.00000000));
	MaterialFloat Local244 = (DERIV_BASE_VALUE(Local99) * 64.00000000);
	MaterialFloat Local245 = CustomExpression2(Parameters);
	MaterialFloat Local246 = (DERIV_BASE_VALUE(Local244) + Local245);
	MaterialFloat Local247 = (Parameters.TwoSidedSign * 32.00000000);
	MaterialFloat Local248 = (Local246 + Local247);
	MaterialFloat Local249 = floor(Local248);
	MaterialFloat Local250 = (Local249 / 64.00000000);
	MaterialFloat Local251 = frac(Local250);
	MaterialFloat Local252 = (DERIV_BASE_VALUE(Local251) * 0.99800003);
	MaterialFloat Local253 = (DERIV_BASE_VALUE(Local252) + 0.00100000);
	MaterialFloat Local254 = (Local214 + DERIV_BASE_VALUE(Local253));
	MaterialFloat Local255 = (Local254 - 0.50000000);
	MaterialFloat Local256 = round(Local255);
	MaterialFloat Local257 = select((abs(Local256 - 0.50000000) > 0.00001000), select((Local256 >= 0.50000000), 0.00000000, Local243), 0.00000000);
	MaterialFloat Local258 = (GetPathTracingQualitySwitch() ? (Local257) : (Local243));

	PixelMaterialInputs.EmissiveColor = Local30;
	PixelMaterialInputs.Opacity = Local242;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local207;
	PixelMaterialInputs.Metallic = Local214;
	PixelMaterialInputs.Specular = Local232;
	PixelMaterialInputs.Roughness = Local241;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Normal = Local29;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = 0;
	PixelMaterialInputs.AmbientOcclusion = 1.00000000;
	PixelMaterialInputs.Refraction = MaterialFloat3(MaterialFloat2(Local258,0.0f),Material.PreshaderBuffer[32].w);
