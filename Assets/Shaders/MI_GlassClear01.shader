Shader "Unreal/MI_GlassClear01"
{
    Properties
    {
		...
		Material_Texture2D_7( "MetallicMap", 2D ) = "white" {}
		Material_Texture2D_8( "OpacityMap", 2D ) = "white" {}
		Material_Texture2D_9( "RoughnessMap", 2D ) = "white" {}
