...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = ReflectionAboutCustomWorldNormal(Parameters, MaterialFloat3(0.00000000,0.00000000,0.00000000).rgb, false);
	MaterialFloat Local1 = MaterialStoreTexCoordScale(Parameters, Local0, 0);
	MaterialFloat4 Local2 = ProcessMaterialLinearColorTextureLookup(TextureCubeSample(Material_TextureCube_0,sampler_Material_TextureCube_0,Local0));
