...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[20] = float4(0.036889,0.034340,0.033105,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.036889,0.034340,0.033105,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(1.700000,1.000000,0.700000,0.700000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(0.000000,0.000000,4.000000,4.000000);//(Unknown)
	Material.PreshaderBuffer[30] = float4(4.000000,0.000000,0.000000,4.000000);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,4.000000,4.000000);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.000000,0.000000,4.000000,4.000000);//(Unknown)
}
