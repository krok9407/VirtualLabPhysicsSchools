Shader "Unreal/MI_BackyardChair11CushionBase"
{
    Properties
    {
		...
		Material_Texture2D_6( "OpacityMap", 2D ) = "white" {}
		Material_Texture2D_7( "T_Bayer64_Grayscale_64px", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "MI_BackyardChair11CushionBase.hlsl"
