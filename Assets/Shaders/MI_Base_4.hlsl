...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(1.572453,0.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(0.070360,0.070360,0.070360,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.070360,0.070360,0.070360,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(0.000000,0.000000,2.976601,2.976601);//(Unknown)
	Material.PreshaderBuffer[30] = float4(2.976601,0.000000,0.000000,2.976601);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,2.976601,2.976601);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.000000,0.000000,2.976601,2.976601);//(Unknown)
}
