...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[10] = float4(6200.000000,1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(0.002123,0.002086,0.002086,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.002123,0.002086,0.002086,0.000000);//(Unknown)
