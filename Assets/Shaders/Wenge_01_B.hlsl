...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[20] = float4(0.114435,0.074214,0.052861,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.114435,0.074214,0.052861,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(0.000000,0.000000,3.298556,0.230659);//(Unknown)
	Material.PreshaderBuffer[30] = float4(0.230659,0.000000,0.000000,3.298556);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,3.298556,0.230659);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.000000,0.000000,3.298556,0.230659);//(Unknown)
}
