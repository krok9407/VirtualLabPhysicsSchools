...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[19] = float4(0.000000,0.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[22] = float4(1.000000,1.000000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[27] = float4(1.000000,1.000000,1.000000,2.000000);//(Unknown)
	...
	Material.PreshaderBuffer[30] = float4(0.300000,1.000000,1.000000,0.000000);//(Unknown)
