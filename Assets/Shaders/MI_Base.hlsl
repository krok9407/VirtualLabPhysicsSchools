...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[29] = float4(0.050000,0.000000,2.292087,2.976601);//(Unknown)
	Material.PreshaderBuffer[30] = float4(2.976601,0.050000,0.000000,2.292087);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.050000,0.000000,2.292087,2.976601);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.050000,0.000000,2.292087,2.976601);//(Unknown)
}
