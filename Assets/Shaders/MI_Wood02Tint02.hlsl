...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[1] = float4(0.000000,0.250000,0.000000,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[20] = float4(0.723055,0.502887,0.262251,0.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.723055,0.502887,0.262251,0.000000);//(Unknown)
