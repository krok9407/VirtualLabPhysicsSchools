...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[20] = float4(0.171441,0.147027,0.127438,1.000000);//(Unknown)
	Material.PreshaderBuffer[21] = float4(0.171441,0.147027,0.127438,0.000000);//(Unknown)
	...
	Material.PreshaderBuffer[24] = float4(2.000000,1.000000,1.000000,1.000000);//(Unknown)
	...
	Material.PreshaderBuffer[29] = float4(0.000000,0.000000,0.379501,0.379501);//(Unknown)
	Material.PreshaderBuffer[30] = float4(0.379501,0.000000,0.000000,0.379501);//(Unknown)
	Material.PreshaderBuffer[31] = float4(0.000000,0.000000,0.379501,0.379501);//(Unknown)
	Material.PreshaderBuffer[32] = float4(0.000000,0.000000,0.379501,0.379501);//(Unknown)
}
