Shader "Unreal/Dark_tinted_glass"
{
    Properties
    {
		...
		Material_Texture2D_3( "GradientMap", 2D ) = "white" {}
		Material_Texture2D_4( "Good64x64TilingNoiseHighFreq", 2D ) = "white" {}
		Material_Texture2D_5( "T_Imperfections_Masks", 2D ) = "white" {}
		Material_Texture2D_6( "T_Cloud_Mask", 2D ) = "white" {}
		Material_Texture2D_7( "OpacityMap", 2D ) = "white" {}
		Material_Texture2D_8( "T_Bayer64_Grayscale_64px", 2D ) = "white" {}
		Material_Texture2D_9( "MetallicMap", 2D ) = "white" {}
		Material_Texture2D_10( "RoughnessMap", 2D ) = "white" {}
    ...
    SubShader
    {
        ...
        #include "Dark_tinted_glass.hlsl"
