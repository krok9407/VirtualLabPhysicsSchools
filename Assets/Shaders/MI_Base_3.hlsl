...
void InitializeExpressions()
{
	...
	Material.PreshaderBuffer[29] = float4(-0.370000,0.000000,2.359924,2.976601);//(Unknown)
	Material.PreshaderBuffer[30] = float4(2.976601,-0.370000,0.000000,2.359924);//(Unknown)
	Material.PreshaderBuffer[31] = float4(-0.370000,0.000000,2.359924,2.976601);//(Unknown)
	Material.PreshaderBuffer[32] = float4(-0.370000,0.000000,2.359924,2.976601);//(Unknown)
}
